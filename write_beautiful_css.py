...
.notification-card.unread {
    ...
    background: linear-gradient(135deg, rgba(102,126,234,0.05), white);
}
...
.notification-text strong { color: var(--primary); font-weight: 700; }
...
print("Beautiful CSS written successfully!")